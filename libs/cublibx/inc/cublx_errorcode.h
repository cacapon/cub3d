...
/*   Updated: 2025/09/22 08:37:57 by ttsubo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_CUBLX_001 "Failed to allocate cublx." 
# define ERR_CUBLX_002 "Failed to initialize mlx."
# define ERR_CUBLX_003 "Failed to create window."
# define ERR_CUBLX_004 "Failed to allocate cub_user."
# define ERR_CUBLX_005 "Failed to create view." 
# define ERR_CUBLX_006 "Failed to get data address." 
# define ERR_CUBLX_007 "Failed to create views." 
